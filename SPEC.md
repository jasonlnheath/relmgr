...
| Phone display format | **+1 (XXX) XXX-XXXX everywhere** (UX pass 7, 2026-10-xx) — display-time only (`format_phone_display`); stored values are never rewritten; non-US numbers render unchanged. |
